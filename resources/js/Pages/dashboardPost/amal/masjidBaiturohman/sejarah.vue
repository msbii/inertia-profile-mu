...
// Debugging
console.log("Sejarah:", props.post);
    ...
    <Layout>
        ...
        >
            ...
            <div class="auto-container">
                <h1>Sejarah Masjid Baiturohman</h1>
            </div>
        </section>
        ...
        <section class="page-info">
            <div class="auto-container clearfix">
                <div class="pull-left"><h2>Sejarah Masjid Baiturohman</h2></div>
                <div class="pull-right">
                    <ul class="bread-crumb clearfix">
                        <li><Link href="/">Beranda</Link></li>
                        <li>Sejarah Masjid Baiturohman</li>
                    </ul>
                </div>
            </div>
        </section>
                        ...
                        <section class="law-section">
                            <div class="text-center">
                                ...
                                <Link href="/amal/masjidBaiturohman"
                                    ...
                                    &ensp; Kembali ke Postingan</Link
                                >
                            </div>
                        </section>
                    </div>
