                ...
                <nav class="nav-outer">
                    <ul>
                        <li
                            :class="{
                                current:
                                    currentPath === '/amal/musholaAlKhasanah',
                            }"
                        >
                            <Link href="/amal/musholaAlKhasanah">Sejarah</Link>
                        </li>

                        <li
                            :class="{
                                current:
                                    currentPath === '/sk/musholaAlKhasanah',
                            }"
                        >
                            <Link href="/sk/musholaAlKhasanah">SK Ranting</Link>
                        </li>
                        ...
                        <li
                            :class="{
                                current:
                                    currentPath ===
                                    '/struktur/musholaAlKhasanah',
                            }"
                        >
                            <Link href="/struktur/musholaAlKhasanah"
                        ...
                        >
                            ...
                            <ul class="dropdown-menu">
                                ...
                                >
                                    <Link
                                        :href="`/kajian/musholaAlKhasanah/${item.slug}`"
                                        >{{ item.name }}</Link
                                    >
                                </li>
                            </ul>
