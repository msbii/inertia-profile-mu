            ...
            <div class="widget sidebar-widget boxed-nav">
                <nav class="nav-outer">
                    <ul>
                        <li
                            :class="{
                                current: currentPath === '/amal/masjidAlIkhsan',
                            }"
                        >
                            <Link href="/amal/masjidAlIkhsan">Sejarah</Link>
                        </li>

                        <li
                            :class="{
                                current: currentPath === '/sk/masjidAlIkhsan',
                            }"
                        >
                            <Link href="/sk/masjidAlIkhsan">SK Ranting</Link>
                        </li>

                        <li
                            :class="{
                                current:
                                    currentPath === '/struktur/masjidAlIkhsan',
                            }"
                        >
                            <Link href="/struktur/masjidAlIkhsan"
                        ...
                        >
                            ...
                            <ul class="dropdown-menu">
                                ...
                                >
                                    <Link
                                        :href="`/kajian/masjidAlIkhsan/${item.slug}`"
                                        >{{ item.name }}</Link
                                    >
                                </li>
                            </ul>
