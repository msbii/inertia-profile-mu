                            ...
                            <tbody v-if="categories?.data.length">
                                ...
                                >
                                    ...
                                    >
                                        <!-- Tombol Lihat -->
                                        <!-- <Link
                                            :href="`/dashboard/categories/${post.slug}`"
                                        >
                                            <button
                                        ...
                                        <!-- Tombol Ubah -->
                                        <Link
                                            :href="`/dashboard/categories/${post.slug}/edit`"
                                        >
                                            <button
...
function handleDelete(slug) {
    if (confirm("Are you sure?")) {
        router.delete(`/dashboard/categories/${slug}`);
    }
}
...
const submit = () => {
    router.get(
        "/dashboard/categories", // Ganti sesuai route kamu
        { search: search.value },
        {
            preserveState: true,
            preserveScroll: true,
