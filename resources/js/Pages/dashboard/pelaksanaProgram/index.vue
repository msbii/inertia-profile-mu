                    ...
                    <div class="rounded-t mb-0 px-4 py-3 border-0">
                        <div class="flex flex-wrap items-center">
                            ...
                            >
                                ...
                                <Link
                                    href="/dashboard/pelaksanaanProgram/create"
                                >
                                    <button
                                        type="button"
                            ...
                            <tbody v-if="posts?.data?.length">
                                ...
                                >
                                    ...
                                    >
                                        <!-- Tombol Lihat -->
                                        <Link
                                            :href="`/dashboard/pelaksanaanProgram/${post.slug}`"
                                        >
                                            <button
                                        ...
                                        <!-- Tombol Ubah -->
                                        <Link
                                            :href="`/dashboard/pelaksanaanProgram/${post.slug}/edit`"
                                        >
                                            <button
...
function handleDelete(slug) {
    if (confirm("Are you sure?")) {
        router.delete(`/dashboard/pelaksanaanProgram/${slug}`);
    }
}
...
const submit = () => {
    router.get(
        "/dashboard/pelaksanaanProgram", // Ganti sesuai route kamu
        { search: search.value },
        {
            preserveState: true,
            preserveScroll: true,
