                    ...
                    <div class="rounded-t mb-0 px-4 py-3 border-0">
                        <div class="flex flex-wrap items-center">
                            ...
                            >
                                ...
                                <a
                                    :href="`/dashboard/exportUsers?search=${filters.search}`"
                                    class="btn-export"
                                >
                                    Export Sesuai Pencarian
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody v-if="user?.data.length">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <!-- Tombol Ubah -->
                                        <Link
                                            :href="`/dashboard/user/${post.slug}/edit`"
                                        >
                                            <button
...
const submit = () => {
    router.get(
        "/dashboard/user", // Ganti sesuai route kamu
        { search: search.value },
        {
            preserveState: true,
            preserveScroll: true,
