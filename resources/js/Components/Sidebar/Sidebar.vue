<template>
    <nav
        class="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden bg-blue flex flex-wrap items-center justify-between md:w-64 z-10 py-4 px-6 min-h-screen border-r border-blueGray-200 shadow-none"
    >
        <div
