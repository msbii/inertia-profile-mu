...
class AmalMasjidAlKhasanahController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('dashboardPost/amal/masjidAlKhasanah/index', [
            "title" => "Single post",
            "active" => "posts",
    ...
    public function showSejarah()
    {
        ...
        return Inertia::render('dashboardPost/amal/masjidAlKhasanah/sejarah', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
    ...
    public function showSK()
    {
        ...
        return Inertia::render('dashboardPost/amal/masjidAlKhasanah/detailSK', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
    ...
    public function showStruktur()
    {
        ...
        return Inertia::render('dashboardPost/amal/masjidAlKhasanah/struktur', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
    ...
    public function showKajian($slug)
    {
        ...
        return Inertia::render('dashboardPost/amal/masjidAlKhasanah/kajian',[
