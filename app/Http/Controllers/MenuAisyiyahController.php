...
class MenuAisyiyahController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('dashboardPost/menu/aisyiyah/index', [
            "title" => "Single post",
            "active" => "posts",
    ...
    public function showMusyawarah()
    {
        ...
        return Inertia::render('dashboardPost/menu/aisyiyah/musyawarah', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
            "kategoriSK" => $kategoriSK,
    ...
    public function detailMusyawarah($slug)
    {
        ...
        return Inertia::render('dashboardPost/menu/aisyiyah/detailMusyawarah', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
            "kategoriSK" => $kategoriSK,
    ...
    public function showStruktur()
    {
        ...
        return Inertia::render('dashboardPost/menu/aisyiyah/struktur', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
            "kategoriSK" => $kategoriSK,
    ...
    public function showSK($slug)
    {
        ...
        return Inertia::render('dashboardPost/menu/aisyiyah/detailSK', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
            "kategoriSK" => $kategoriSK,
    ...
    public function showKajian($slug)
    {
        ...
        return Inertia::render('dashboardPost/menu/aisyiyah/kajian',[
    ...
    public function showPelaksana($slug)
    {
        ...
        return Inertia::render('dashboardPost/menu/aisyiyah/pelaksana', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
            "kategoriSK" => $kategoriSK,
    ...
    public function showInventaris()
    {
        ...
        return Inertia::render('dashboardPost/menu/aisyiyah/inventaris', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
            "kategoriSK" => $kategoriSK,
    ...
    public function detailInventaris($slug)
    {
        ...
        return Inertia::render('dashboardPost/menu/aisyiyah/detailInventaris', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
            "kategoriSK" => $kategoriSK,
