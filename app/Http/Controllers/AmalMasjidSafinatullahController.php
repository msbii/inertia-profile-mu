...
class AmalMasjidSafinatullahController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('dashboardPost/amal/masjidSafinatullah/index', [
            "title" => "Single post",
            "active" => "posts",
    ...
    public function showSejarah()
    {
        ...
        return Inertia::render('dashboardPost/amal/masjidSafinatullah/sejarah', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
    ...
    public function showSK()
    {
        ...
        return Inertia::render('dashboardPost/amal/masjidSafinatullah/detailSK', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
    ...
    public function showStruktur()
    {
        ...
        return Inertia::render('dashboardPost/amal/masjidSafinatullah/struktur', [
            "title" => "Single post",
            "active" => "posts",
            "kategoriKajian" => $kategoriKajian,
    ...
    public function showKajian($slug)
    {
        ...
        return Inertia::render('dashboardPost/amal/masjidSafinatullah/kajian',[
